...
## # ------------------------------------------------------------------------------ #
## T_SOURCE=halfcheetah_sac_alpha0-2_fix_alpha_s40
## B_PATH=halfcheetah_sac_alpha0-2_fix_alpha/${T_SOURCE}/buffer/final_buffer-maxsize-1000000-steps-1000000-noise-0-alpha-0.2-updateAlpha-False.p
##
## PREV=1000000
## NEXT=1000000
## NAME=halfcheetah_sac_to_td3_offline_curriculum_ep_${EPOCHS}_${TYPE}_p_${PREV}_n_${NEXT}
...
##
## C_SCALE=1.00
## NAME=halfcheetah_sac_to_td3_offline_curriculum_ep_${EPOCHS}_${TYPE}_scale_${C_SCALE}t
## for SEED in 90 91 92 93 94 ; do
##     taskset -c ${CPU1}-${CPU2} python spinup/teaching/offline_rl.py  \
##         --env ${ENV}  --exp_name ${NAME}  --seed ${SEED}  -bp ${B_PATH}  --t_source ${T_SOURCE} \
...
PREV=1000000
NEXT=1000000
NAME=halfcheetah_td3_to_sac_offline_curriculum_ep_${EPOCHS}_${TYPE}_p_${PREV}_n_${NEXT}
for SEED in 90 91 92 93 94 ; do
...
C_SCALE=1.00
NAME=halfcheetah_td3_to_sac_offline_curriculum_ep_${EPOCHS}_${TYPE}_scale_${C_SCALE}t
for SEED in 90 91 92 93 94 ; do
    taskset -c ${CPU1}-${CPU2} python spinup/teaching/offline_rl.py  --algorithm sac \
        --env ${ENV}  --exp_name ${NAME}  --seed ${SEED}  -bp ${B_PATH}  --t_source ${T_SOURCE} \
        --curriculum ${TYPE}  --c_scale ${C_SCALE}  --epochs ${EPOCHS}
