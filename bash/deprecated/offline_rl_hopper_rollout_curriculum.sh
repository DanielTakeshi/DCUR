# ------------------------------------------------------------------------------ #
# Offline RL -- handle the _curriculum_ case, with rolled out data from s40 teacher for Hopper.
# ------------------------------------------------------------------------------ #
CPU1=0
CPU2=8
ENV=Hopper-v3
...
for DIST_B in uniform_0.0_1.50 uniformeps_0.0_1.50_0.9_filter nonaddunif_0.0_0.5_filter ; do
    ...
    NAME=hopper_td3_offline_${DIST_B}_curriculum_${TYPE}_p_${PREV}_n_${NEXT}
