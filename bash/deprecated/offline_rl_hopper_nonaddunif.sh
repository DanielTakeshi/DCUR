...
##     NAME=hopper_td3_offline_${DIST_B}
...
for DIST_B in nonaddunif_0.0_0.5_filter nonaddunif_0.0_1.0_filter ; do
    B_PATH=hopper_td3_act0-1/${T_SOURCE}/buffer/rollout-maxsize-1000000-steps-1000000-noise-${DIST_B}-dtype-train.p
    N_PATH=hopper_td3_act0-1/${T_SOURCE}/experiments/sigma_predictor-${DIST_B}-t-1000000-v-0200000-seed-01.tar
...
for DIST_B in nonaddunif_0.0_0.5_filter nonaddunif_0.0_1.0_filter ; do
    B_PATH=hopper_td3_act0-5/${T_SOURCE}/buffer/rollout-maxsize-1000000-steps-1000000-noise-${DIST_B}-dtype-train.p
    N_PATH=hopper_td3_act0-5/${T_SOURCE}/experiments/sigma_predictor-${DIST_B}-t-1000000-v-0200000-seed-01.tar
    for N_ALPHA in 1.0 10.0 50.0 ; do
        NAME=hopper_td3_offline_${DIST_B}_np_${N_ALPHA}
        B_PATH=hopper_td3_act0-5/${T_SOURCE}/buffer/rollout-maxsize-1000000-steps-1000000-noise-${DIST_B}-dtype-train.p
        for SEED in 10 20 ; do
