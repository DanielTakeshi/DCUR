...
## NAME=hopper_td3_offline_finalb
...
##
## NAME=hopper_td3_offline_finalb
## T_SOURCE=hopper_td3_act0-5_s40
## B_PATH=hopper_td3_act0-5/${T_SOURCE}/buffer/final_buffer-maxsize-1000000-steps-1000000-noise-0.5.p
## for SEED in 10 20 ; do
##     taskset -c ${CPU1}-${CPU2} python spinup/teaching/offline_rl.py  \
##         --env ${ENV}  --exp_name ${NAME}  --seed ${SEED}  -bp ${B_PATH}  --t_source ${T_SOURCE}
## done
...
##     NAME=hopper_td3_offline_finalb_gtrewshape_${N_ALPHA}
##     for SEED in 10 20 ; do
##         taskset -c ${CPU1}-${CPU2} python spinup/teaching/offline_rl.py  \
...
T_SOURCE=hopper_td3_act0-1_s40
B_PATH=hopper_td3_act0-1/${T_SOURCE}/buffer/final_buffer-maxsize-1000000-steps-1000000-noise-0.1.p
N_PATH=hopper_td3_act0-1/${T_SOURCE}/experiments/sigma_predictor-time_prediction-tot-1000000-seed-01.tar
for N_ALPHA in 1.0 10.0 ; do
    NAME=hopper_td3_offline_finalb_np_${N_ALPHA}
    for SEED in 10 20 ; do
        taskset -c ${CPU1}-${CPU2} python spinup/teaching/offline_rl.py  \
            --env ${ENV}  --exp_name ${NAME}  --seed ${SEED}  -bp ${B_PATH}  --t_source ${T_SOURCE}  -np ${N_PATH}  -na ${N_ALPHA}
    done
    NAME=hopper_td3_offline_concurrent_np_${N_ALPHA}
    for SEED in 10 20 ; do
        taskset -c ${CPU1}-${CPU2} python spinup/teaching/offline_rl.py  \
            --env ${ENV}  --exp_name ${NAME}  --seed ${SEED}  -bp ${B_PATH}  --t_source ${T_SOURCE}  -np ${N_PATH}  -na ${N_ALPHA}  --concurrent
    done
done

T_SOURCE=hopper_td3_act0-5_s40
B_PATH=hopper_td3_act0-5/${T_SOURCE}/buffer/final_buffer-maxsize-1000000-steps-1000000-noise-0.5.p
N_PATH=hopper_td3_act0-5/${T_SOURCE}/experiments/sigma_predictor-time_prediction-tot-1000000-seed-01.tar
for N_ALPHA in 1.0 10.0 ; do
    NAME=hopper_td3_offline_finalb_np_${N_ALPHA}
    for SEED in 10 20 ; do
        taskset -c ${CPU1}-${CPU2} python spinup/teaching/offline_rl.py  \
