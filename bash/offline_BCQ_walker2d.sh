...
ENV=Walker2d-v3
NAME=walker2d_BCQ_offline_${DIST}
...
for DIST in uniform_0.0_0.25 uniform_0.0_0.50 uniform_0.0_0.75 uniform_0.0_1.00 uniform_0.0_1.25 uniformeps_0.0_0.25_0.5_filter uniformeps_0.0_0.50_0.5_filteruniformeps_0.0_0.75_0.5_filteruniformeps_0.0_1.00_0.5_filteruniformeps_0.0_1.25_0.5_filteruniformeps_0.0_0.25_0.5_nofiltuniformeps_0.0_0.50_0.5_nofiltuniformeps_0.0_0.75_0.5_nofiltuniformeps_0.0_1.00_0.5_nofilt ; do
    NAME=walker2d_BCQ_offline_${DIST}
    B_PATH=walker2d_td3_act0-1/${T_SOURCE}/buffer/rollout-maxsize-1000000-steps-1000000-noise-${DIST}-dtype-train.p
