...
NAME=hopper_td3_online_stud_total_${STUDENT_SIZE}_curriculum_${TYPE}_p_${PREV}_n_${NEXT}
...
NAME=hopper_td3_online_stud_total_${STUDENT_SIZE}_curriculum_${TYPE}_scale_${C_SCALE}t
for SEED in 30 31 32 ; do
    taskset -c ${CPU1}-${CPU2} python spinup/teaching/online_rl.py  \
