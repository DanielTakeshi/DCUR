...
for N_ALPHA in 10 ; do
    #NAME=hopper_td3_online_stud_total_${STUDENT_SIZE}_curriculum_ep_${EPOCHS}_${TYPE}_p_${PREV}_n_${NEXT}_overlap_tp_${N_ALPHA}
    NAME=hopper_td3_online_stud_total_${STUDENT_SIZE}_curriculum_ep_${EPOCHS}_${TYPE}_p_${PREV}_n_${NEXT}_overlap_data-aug_tp_${N_ALPHA}_rbase1
...
for N_ALPHA in 10 ; do
    #NAME=hopper_td3_online_stud_total_${STUDENT_SIZE}_curriculum_ep_${EPOCHS}_${TYPE}_scale_${C_SCALE}t_overlap_tp_${N_ALPHA}
    NAME=hopper_td3_online_stud_total_${STUDENT_SIZE}_curriculum_ep_${EPOCHS}_${TYPE}_scale_${C_SCALE}t_overlap_data-aug_tp_${N_ALPHA}_rbase1
    for SEED in 30 31 32 ; do
        taskset -c ${CPU1}-${CPU2} python spinup/teaching/online_rl.py  \
