...
NAME=ant_td3_offline_curriculum_ep_${EPOCHS}_${TYPE}_p_${PREV}_n_${NEXT}
...
##     NAME=ant_td3_offline_curriculum_ep_${EPOCHS}_${TYPE}_p_${PREV}_n_${NEXT}_tp_${N_ALPHA}
##     for SEED in 30 31 32 33 34 ; do
##         taskset -c ${CPU1}-${CPU2} python spinup/teaching/offline_rl.py  \
...
## C_SCALE=1.00
##
## NAME=ant_td3_offline_curriculum_ep_${EPOCHS}_${TYPE}_scale_${C_SCALE}t
## for SEED in 30 31 32 33 34 ; do
##     taskset -c ${CPU1}-${CPU2} python spinup/teaching/offline_rl.py  \
...
##
## for N_ALPHA in 1 10 30 50 100 ; do
##     NAME=ant_td3_offline_curriculum_ep_${EPOCHS}_${TYPE}_scale_${C_SCALE}t_tp_${N_ALPHA}
##     for SEED in 30 31 32 33 34 ; do
##         taskset -c ${CPU1}-${CPU2} python spinup/teaching/offline_rl.py  \
...
##
## for N_ALPHA in 0 ; do
##     NAME=ant_td3_offline_curriculum_ep_${EPOCHS}_${TYPE}_p_${PREV}_n_${NEXT}_data-aug_tp_${N_ALPHA}
##     for SEED in 60 ; do
##         taskset -c ${CPU1}-${CPU2} python spinup/teaching/offline_rl.py  \
##             --env ${ENV}  --exp_name ${NAME}  --seed ${SEED}  -bp ${B_PATH}  --t_source ${T_SOURCE}  --curriculum ${TYPE}  --c_prev ${PREV}  --c_next ${NEXT} \
##             --n_alpha ${N_ALPHA}  -tp ${T_PATH}  --epochs ${EPOCHS}
