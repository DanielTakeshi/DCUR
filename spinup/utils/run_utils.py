...
def setup_logger_kwargs(exp_name, seed=None, data_dir=None, datestamp=False,
    ...
    Daniel: adding some args to make data saving a bit better for Offlin eRL.
    """
    ...
    if seed is not None:
        ...
        elif offline_rl_source is not None:
            subfolder = ''.join([offline_rl_source, '_s', str(seed)])
        else:
